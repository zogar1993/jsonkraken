...
abstract class JsonValue: Iterable<Any?> {
	...
	open operator  fun set(key: String, value: JsonValue): Unit = throw UnsupportedOperationException()
	...
	open operator  fun set(index: Int, value: JsonValue): Unit = throw UnsupportedOperationException()
